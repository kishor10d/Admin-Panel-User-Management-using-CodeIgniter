...
class Login_model extends CI_Model
{
    ...
    {
        $this->db->select('BaseTbl.userId, BaseTbl.password, BaseTbl.name, BaseTbl.roleId, Roles.group_name');
        $this->db->from('tbl_users as BaseTbl');
        $this->db->join('tbl_groups as Roles','Roles.group_id = BaseTbl.roleId');
